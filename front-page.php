...
<div class="page-banner">
      ...
      <div class="page-banner__content container t-center c-white">
        <h1 class="headline headline--large">Welcome to your future!</h1>
      ...
      <div class="full-width-split__two">
        <div class="full-width-split__inner">
          ...
          <div class="event-summary">
            ...
            <div class="event-summary__content">
              <h5 class="event-summary__title headline headline--tiny"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h5>
              <p><?php echo wp_trim_words(get_the_excerpt(), 10); ?> <a href="<?php the_permalink(); ?>" class="nu gray">Read more</a></p>
            </div>
          </div>
          <?php } 
          wp_reset_postdata();
          ...
          <p class="t-center no-margin"><a href="<?php echo get_site_url() . '/blog'; ?>" class="btn btn--yellow">View All Blog Posts</a></p>
        </div>
      </div>
    </div>
